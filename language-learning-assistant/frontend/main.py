...
from backend.chat import MistralChat
...
def render_chat_stage():
    ...
    st.header("Chat with Nova - German Learning Assistant")

    # Introduction text
    st.markdown("""
Welcome to your German learning assistant! Here you can practice your German skills.
Ask questions about grammar, vocabulary, or get translations and explanations.
""")

    # Initialize MistralChat instance if not in session state
    if 'mistral_chat' not in st.session_state:
        st.session_state.mistral_chat = MistralChat()
...
def process_message(message: str):
    ...
    with st.chat_message("assistant", avatar="🤖"):
        response = st.session_state.mistral_chat.generate_response(message)
        if response:
